...
export class SectionsComponent implements OnInit {
  ...
  constructor(private lessons: LessonsService, private usersService: UsersService) { }
  ...
  sections = [
    ...
    { title: 'most popular', block: [], get: [11, 12, 13, 14, 15, 16, 17, 18, 19], mustloggin: false },
    { title: 'your lessons', block: [], get: [5, 6, 7, 8, 9, 10], mustloggin: true },
  ]
